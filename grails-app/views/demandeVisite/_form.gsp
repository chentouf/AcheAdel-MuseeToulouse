...
<div class="fieldcontain ${hasErrors(bean: demandeVisiteInstance, field: 'dateDemande', 'error')} required">
	<label for="dateDemande">
		<g:message code="demandeVisite.dateDemande.label" default="Date Demande" />
		<span class="required-indicator">*</span>
	</label>
	<g:datePicker name="dateDemande" precision="day"  value="${demandeVisiteInstance?.dateDemande}"  />
