	...
	<body>
		...
		<div id="show-demandeVisite" class="content scaffold-show" role="main">
			...
			<ol class="property-list demandeVisite">
				...
				<g:if test="${demandeVisiteInstance?.dateDemande}">
				<li class="fieldcontain">
					<span id="dateDemande-label" class="property-label"><g:message code="demandeVisite.dateDemande.label" default="Date Demande" /></span>
					
						<span class="property-value" aria-labelledby="dateDemande-label"><g:formatDate date="${demandeVisiteInstance?.dateDemande}" /></span>
